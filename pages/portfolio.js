        ...
        {/* <div className="col-lg-4 col-sm-6">
                                <ScrollAnimation animateIn="fadeInUp" delay={100} animateOnce={true}>
                                    <div className="features-box">
                                        ...
                                        <h3>Vision</h3>
                                        <p>To be the top IT firm in the nation and the globe by developing a wide range of goods and services, hiring individuals who are incredibly brilliant and enthusiastic while maintaining a humble and down-to-earth demeanour.
                                        </p>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <ScrollAnimation animateIn="fadeInUp" delay={250} animateOnce={true}>
                                    <div className="features-box">
                                        ...
                                        <h3>Mission</h3>
                                        <p>Work excellence is our basic principle whereby we provide our internal and external customers with innovative products and services that satisfy them. We strive to help our customers achieve scalable eCommerce and software solutions. </p>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <ScrollAnimation animateIn="fadeInUp" delay={300} animateOnce={true}>
                                    <div className="features-box">
                                        ...
                                        <h3>Core Values</h3>
                                        <p>Being creative, being innovative and being committed to both our passion as well as our clients are the central tenets that we adhere to.Our team promotes counterintuitive learning by iterating over the motto: “Experiment, learn, repeat”. </p>
